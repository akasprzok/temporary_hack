    ...
    <section class="top-0 flex flex-wrap md:flex-col justify-between md:justify-start items-center gap-2 px-4 pt-4">
      ...
      <div class="w-full md:w-auto mt-4 md:bg-none pb-6">
        ...
        <ul class="pt-2 grid grid-cols-2 md:grid-cols-1 grid-rows-2 md:grid-rows-4 grid-flow-col gap-2 text-md mt-2">
          <li>I am <span class="font-medium font-sans">looking for work</span></li>
          <li>I live in <span class="font-medium font-sans">Seattle</span></li>
          <li class="flex">
            <a class="flex-1 flex justify-center" href="https://twitter.com/akasprzok">
            ...
            <a class="flex-1 flex justify-center" href="https://github.com/akasprzok">
            ...
            <a
              ...
              href="https://www.linkedin.com/in/akasprzok/"
              target="_blank"
            >
              <svg xmlns="http://www.w3.org/2000/svg" fill="#0e76a8" width="24" height="24" viewBox="0 0 24 24"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z" /></svg>
            </a>
          </li>
        </ul>
      </div>
